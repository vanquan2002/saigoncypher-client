...
const Contents = () => {
  ...
  return (
    <main>
      ...
      <div className="px-5 md:px-20 mt-7 md:mt-14 flex flex-col gap-5">
        <p className="text-neutral-800 font-light leading-relaxed">
          Chào mừng bạn đến với Chào mừng quý khách hàng đến với
          https://store.saigoncypher.vn/, điểm đến lý tưởng cho những chiếc áo
          thun boxy thời thượng, dành riêng cho giới trẻ yêu thích phong cách và
          sự tự do.
        </p>
