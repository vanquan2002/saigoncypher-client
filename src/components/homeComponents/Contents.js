    ...
    <main className="mt-20 px-2 md:px-20">
      {loading ? (
        ...
        <div className="flex flex-col items-center">
          <span className="uppercase text-xl md:text-3xl font-medium">
            Sản phẩm mới nhất
          </span>
              ...
              {products.slice(0, 8).map((product, i) => (
                <li key={i}>
                  ...
                  <div className="mt-1 px-1 md:px-0">
                    <Link to={`/products/${product._id}/detail`}>
                      <h2 className="cursor-pointer uppercase line-clamp-1 hover:underline text-xs md:text-sm font-medium">
                        {product.name}
                      </h2>
                    </Link>
          ...
          <Link
            ...
            className="mt-5 md:mt-10 cursor-pointer hover:underline font-medium text-xs md:text-sm uppercase"
          >
            {"["} Xem tất cả sản phẩm {"]"}
          </Link>
        </div>
