      ...
      <div className="flex flex-col lg:flex-row gap-x-20 gap-y-9 mt-8 md:mt-10">
        <div className="w-full">
          ...
          <ul className="mt-3 flex flex-col md:gap-5">
            {[1, 2].map((item, i) => (
              ...
              >
                <div className="col-span-1 bg-gray-100 aspect-[2/3]"></div>
        ...
        <div className="w-full flex flex-col gap-8 px-5 md:px-0">
          <div className="flex flex-col gap-2">
            <div className="bg-gray-100 h-[18px] w-1/2"></div>
            <div className="bg-gray-100 h-[18px] w-full"></div>
            <div className="bg-gray-100 h-[18px] w-3/5"></div>
          </div>

          <div>
            <div className="bg-gray-100 h-5 w-1/2"></div>
            <div className="mt-2 flex justify-between">
              <div className="bg-gray-100 h-[18px] w-1/3"></div>
              <div className="bg-gray-100 h-[18px] w-1/5"></div>
            </div>
          </div>

          <div>
            <div className="bg-gray-100 h-[18px] w-1/2"></div>
            <div className="bg-gray-100 h-[18px] w-2/3 mt-2"></div>
          </div>

          <div>
            <div className="bg-gray-100 h-[18px] w-1/4"></div>
            <div className="bg-gray-100 h-16 w-full mt-2"></div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between border-t border-gray-100 mt-1 pt-[10px]">
              <div className="bg-gray-100 h-[18px] w-1/4"></div>
              <div className="bg-gray-100 h-[18px] w-1/5"></div>
            </div>
          </div>
          ...
          <div className="mt-3">
            <div className="bg-gray-100 h-9 w-full"></div>
            <div className="bg-gray-100 h-4 w-4/5 mt-2"></div>
          </div>
        </div>
      </div>
    </div>
