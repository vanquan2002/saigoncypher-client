    ...
    <div className="animate-pulse">
      <div className="flex flex-col lg:flex-row gap-5 md:gap-10 lg:gap-20">
        ...
        <div className="lg:w-3/5 px-5 md:px-0">
          ...
          <ul className="mt-12 w-full flex flex-col gap-5">
            <li className="h-5 w-full bg-slate-100"></li>
            <li className="h-5 w-full bg-slate-100"></li>
            <li className="h-5 w-full bg-slate-100"></li>
          </ul>
        </div>
      ...
      <div className="mt-40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0.5 md:gap-5 mt-6 md:mt-11">
